...
export const DefaultPortrait =
  'https://res.cloudinary.com/andystevenson/image/upload/e_blur:100,o_20,c_fill,f_auto,g_face:center,h_600,q_auto,w_300/v1691413940/roa/alumni-template.avif'
...
export const handleImage = (ImageElements) => {
  const HandleImageUpload =
    window.FileList && window.File && window.FileReader && ImageElements.image
